...
import { smartphonesArticles } from '../data/articles';
        ...
        <div className="relative max-w-7xl mx-auto px-5 sm:px-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-accent-400 text-sm mt-1">Benchmark, comparativi e test approfonditi</p>
            </div>
          </div>

          <p className="text-ink-300 leading-relaxed max-w-2xl">
            Test approfonditi sui nuovi smartphone, benchmark delle prestazioni, confronti tra modelli e guide all\u2019acquisto.
          </p>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-5 sm:px-8">
          <div className="flex items-center gap-3 mb-8">
            <div className="w-1 h-7 rounded-full bg-gradient-to-b from-accent-400 to-accent-600" />
            <h2 className="font-display font-bold text-2xl text-white">Articoli</h2>
            <span className="text-sm text-ink-500">({smartphonesArticles.length})</span>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {smartphonesArticles.map((article) => (
              <Card
                key={article.id}
                title={article.title}
